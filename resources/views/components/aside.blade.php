    ...
    <div class="filter-group filter-group-light">
        ...
        <div class="filter-options">
            ...
            <label class="filter-option">
                <input type="radio" name="type" value="feminized">

                <span class="filter-radio"></span>

                <span class="filter-option-name">Феминизированный</span>

                <span class="filter-option-count">520</span>
            </label>
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Регулярный</span>
    ...
    <div class="filter-group filter-group-genotype">
        ...
        <div class="filter-genotype-list">
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Сатива</span>
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Преимущественно сатива</span>
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Индика</span>
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Преимущественно индика</span>
            ...
            <label class="filter-option">
                ...
                <span class="filter-option-name">Гибрид</span>
