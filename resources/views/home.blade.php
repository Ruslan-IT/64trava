            ...
            <div class="container">
                <div class="brands-inner">
                    ...
                    <div class="brands-column">
                        <a href="#">Barney's farm</a>
                        <a href="#">Dutch Bulk</a>
                        <a href="#">Dutch Passion</a>
                        <a href="#">Delicious Seeds</a>
                    </div>
                    <div class="brands-column">
                        <a href="#">DNA Genetics</a>
                        <a href="#">Doctor Choice</a>
                        <a href="#">Ethos seeds</a>
                        <a href="#">Green house</a>
                    </div>
                    <div class="brands-column">
                        <a href="#">Humboldt seeds</a>
                        <a href="#">Mandala seeds</a>
                        <a href="#">Nirvana</a>
                    ...
                    <div class="brands-column">
                        <a href="#">Pyramid seeds</a>
                        <a href="#">Royal Queen Seeds</a>
        ...
        <section class="tags-section">
            ...
            <div class="container">
                ...
                <div class="tags-inner">
                    ...
                    <a href="#" class="tag-button">Sativa</a>
                    <a href="#" class="tag-button">Regular</a>
                    <a href="#" class="tag-button">Haze</a>
                    <a href="#" class="tag-button">Kush</a>
                    <a href="#" class="tag-button">White widow</a>
                    <a href="#" class="tag-button">Mazar</a>
                    <a href="#" class="tag-button">Bruce banner</a>
                    <a href="#" class="tag-button">Gorilla</a>
                    <a href="#" class="tag-button">Big devil</a>
                    <a href="#" class="tag-button">Skunk</a>
                    <a href="#" class="tag-button">Blueberry</a>
                    <a href="#" class="tag-button">Northern Lights</a>
                    <a href="#" class="tag-button">Jack herer</a>
                    <a href="#" class="tag-button">Skywalker</a>
                    <a href="#" class="tag-button">Girl scout cookies</a>
                    <a href="#" class="tag-button">Og kush</a>
                    <a href="#" class="tag-button">Lsd</a>
                    <a href="#" class="tag-button">Zkittles</a>
                    <a href="#" class="tag-button">Ak47</a>
                    <a href="#" class="tag-button">Qelato</a>
                    <a href="#" class="tag-button">Weddinf cake</a>
                ...
                <div class="new-products-header">
                    ...
                    <div class="new-products-row">
                        ...
                        <div class="new-products-buttons">
                            ...
                            <a href="#" class="new-products-button">
                                Автоцветущие
                            </a>
            ...
            <div class="container">
                ...
                <div class="products-grid">
                    ...
                    <article class="products-promo">
                        ...
                        <img
                            src="images/product/bestsellers.jpg"
                            alt="Покупайте наши бестселлеры"
                        ...
                        <p class="products-promo-text">
                            ...
                            elit. Наши популярные товары уже оценили тысячи
                            покупателей.
                        </p>
                        ...
                        <div class="product-info">
                                ...
                                <div class="product-info-row-el">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_16497_8207)">
                                            ...
                                            <path d="M10.8701 3.95189L14.318 0.504009L14.8106 0L15.3146 0.504009L18.7624 3.95189L17.7544 4.94845L14.8106 2.00458L11.8667 4.94845L10.8701 3.95189Z" fill="#585858"/>
                                            ...
                                            <path d="M-0.275391 0.297852H6.90674V1.70679H-0.275391V0.297852Z" fill="#585858"/>
                                            <path d="M-0.275391 9.43848H6.90674V10.8589H-0.275391V9.43848Z" fill="#585858"/>
                                            <path d="M-0.275391 18.5908H6.90674V19.9998H-0.275391V18.5908Z" fill="#585858"/>
                                            <path d="M-0.275391 15.5439H3.34431V16.9529H-0.275391V15.5439Z" fill="#585858"/>
                                            <path d="M-0.275391 12.4858H3.34431V13.9062H-0.275391V12.4858Z" fill="#585858"/>
                                            <path d="M-0.275391 6.3916H3.34431V7.81199H-0.275391V6.3916Z" fill="#585858"/>
                                            <path d="M-0.275391 3.34473H3.34431V4.75366H-0.275391V3.34473Z" fill="#585858"/>
                                        </g>
                                        <defs>
                            ...
                            <div class="product-info-row">
                                ...
                                <svg width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2.61729 1.4292H12.3694C12.3418 1.88333 12.2867 2.29739 12.2178 2.68473H2.75503C2.68616 2.29739 2.63106 1.88333 2.60352 1.4292H2.61729Z" fill="#585858"/>
                                    <path d="M2.80972 16.1885H12.1899C12.2588 16.5758 12.3139 16.9899 12.3552 17.444H2.6582C2.69953 16.9899 2.75462 16.5758 2.82349 16.1885H2.80972Z" fill="#585858"/>
                                    <path d="M4.14666 13.1963H10.8546C10.9097 13.2631 10.9648 13.3299 11.0199 13.3966C11.2679 13.7038 11.4883 14.0511 11.6673 14.4518H3.33398C3.51305 14.0511 3.73343 13.6905 3.98137 13.3966C4.03646 13.3299 4.09156 13.2631 4.14666 13.1963Z" fill="#585858"/>
                                    <path d="M3.27832 4.4209H11.7218C11.5566 4.78153 11.3637 5.10209 11.1571 5.38258C11.0745 5.48944 10.9918 5.58293 10.8954 5.67643H4.09099C3.99457 5.58293 3.91193 5.47608 3.84306 5.38258C3.62267 5.10209 3.42984 4.78153 3.27832 4.4209Z" fill="#585858"/>
                                    <path d="M15 0C15.0275 3.15218 14.4353 5.31597 13.2231 6.8787C12.6446 7.62668 11.9284 8.22773 11.0882 8.72193C10.6061 8.48151 10.0964 8.2678 9.55923 8.08081C10.6612 7.59997 11.5427 6.9722 12.1901 6.13073C13.2231 4.79506 13.7328 2.85834 13.7052 0.0133567L15 0ZM5.46832 10.7789C4.44904 11.233 3.60882 11.8207 2.96143 12.6221C1.87328 13.9711 1.29477 15.9746 1.29477 19.06H0C0 15.6674 0.674931 13.4235 1.94215 11.8474C2.49311 11.1662 3.16804 10.6052 3.92562 10.1511C4.40771 10.3915 4.91736 10.5919 5.45455 10.7789H5.46832Z" fill="#585858"/>
            ...
            <div class="container">
                <div class="news-header">
                    ...
                    <div class="news-header-actions">
                        ...
                        <button class="news-slider-btn news-slider-btn--prev"></button>
                        <button class="news-slider-btn news-slider-btn--next"></button>
                    </div>
                </div>
                ...
                <div class="news-list">
                    <article class="news-card">
                        ...
                        <div class="news-card-meta">
                            <span class="news-card-category">Новости</span>
                            <time datetime="2025-07-10">10 июля 2025</time>
                        </div>

                        <h3>Автоцветы от Humboldt Seed Company</h3>
        ...
        <section class="news-section">
            <div class="container">
                ...
                <div class="news-section-list">
                    ...
                    <article class="news-section-card">
                        ...
                        <h3 class="news-section-card-title">
                            Новые поступления уже в нашем магазине
                        </h3>

                        <p class="news-section-card-text">
                            Рассказываем о новых товарах, интересных предложениях
                            и последних событиях нашего магазина.
                        </p>

                        <a href="#" class="news-section-card-link">
                            Читать далее
                        </a>
                    </article>
                    ...
                    <article class="news-section-card">
                        ...
                        <h3 class="news-section-card-title">
                            Автоцветы от лучших производителей
                        </h3>

                        <p class="news-section-card-text">
                            Подобрали для вас интересные новинки и рассказываем
                            подробнее об их особенностях.
                        </p>
                    ...
                    <article class="news-section-card">
                        ...
                        <p class="news-section-card-text">
                            Полезная информация и рекомендации, которые помогут
                ...
                <div class="news-section-bottom">
                    <p>
                        Lorem ipsum dolor sit amet consectetur. Sagittis morbi diam sapien scelerisque pellentesque non purus amet. Amet tellus pulvinar dis potenti. Consectetur quisque sed consectetur euismod mattis laoreet tristique hendrerit blandit. Amet rutrum viverra semper vulputate. Turpis vulputate sit pulvinar diam ac. Ipsum posuere scelerisque ipsum etiam tempus posuere luctus nunc sem. Quisque elementum pellentesque adipiscing pellentesque varius ipsum a. Eu pharetra pharetra nunc leo scelerisque fames elit sit donec. Vestibulum a pharetra placerat cursus leo est sit leo facilisis.
